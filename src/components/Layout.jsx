  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link className="h-9 w-9 lg:hidden" href="/" aria-label="Home page">
          <Logomark  />
          
        </Link>
        <Link className="hidden h-9 w-auto fill-slate-700 dark:fill-sky-100 lg:block pr-4 items-end"  href="/" aria-label="Home page">
          <Logo />
        </Link>
      </div>
